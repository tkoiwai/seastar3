...
int main(int argc, char *argv[]) {
  ...
  TString ofname = Form("/home/koiwai/analysis/macros/testana_smri%04d.root", FileNum);
  ...
  Double_t hodo_slew[24][3] = {
      {0, 0, 0}, {-50, -50, 2.48}, {-50, -50, 2.38}, {-50, -50, 2.29}, {-55, -55, 2.56}, {-80, -80, 3.30}, {-50, -50, 2.31}, {-50, -50, 2.29}, {-55, -55, 2.47}, {-50, -50, 2.24}, {-55, -55, 2.50}, {-60, -60, 2.70}, {-50, -50, 2.22}, {-55, -55, 2.40}, {-60, -60, 2.59}, {-60, -60, 2.64}, {-70, -70, 2.95}, {-60, -60, 2.49}, {-60, -60, 2.44}, {-60, -60, 2.42}, {-60, -60, 2.40}, {-65, -65, 2.57}, {-90, -90, 3.58}, {0, 0, 0}};
  ...
  for(int iEntry = 0; iEntry < nEntry; ++iEntry) {
    ...
    for(Int_t i = 0; i < 24; i++) {
      ...
      if(allHodo_Q[i] > hodo_q) {
        hodo_q = allHodo_Q[i];
        hodo_t = allHodo_T[i];
        hodo_t += hodo_slew[i][0] / sqrt(Hodoi_QUCal[i] - 300.) + hodo_slew[i][1] / sqrt(Hodoi_QDCal[i] - 300.) + hodo_slew[i][2];
        hodo_id = i + 1;
      }
    }
